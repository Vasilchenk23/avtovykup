...
export const metadata = createPageMetadata({
  ...
  description:
    "Викуп проблемних авто після ДТП, не на ходу, без документів та на іноземній реєстрації у Харкові та області.",
  path: "/posluhy",
});
...
const services: Service[] = [
  ...
  {
    title: "Гроші за авто сьогодні",
    image: "https://images.unsplash.com/photo-1563720223185-11003d516935?auto=format&fit=crop&w=800&q=80",
    badge: "Розрахунок одразу",
    href: "/posluhy/vykup-za-hotivku",
    description:
      "Коли важливі швидкість і гроші сьогодні: погодимо умови та розрахуємося після оформлення.",
    fallbackIcon: "cash",
  },
  {
    title: "Викуп авто не на ходу",
    image: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&w=800&q=80",
    badge: "Мотор або КПП",
    href: "/posluhy/vykup-z-probihom",
    description:
      "Викупимо авто зі зламаним мотором, КПП або іншими серйозними технічними проблемами.",
    fallbackIcon: "used",
  },
];
        ...
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-8 max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg sm:leading-8">
              Оберіть напрям або залиште заявку — оцінимо проблему, організуємо виїзд і безпечне оформлення.
            </p>
          </div>

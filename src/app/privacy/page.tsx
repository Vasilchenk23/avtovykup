...
const sections = [
  {
    ...
    content: (
      <>
        <p>
          Ми збираємо <strong>номер телефону</strong>, який ви добровільно залишаєте для зворотного зв&apos;язку. Ім&apos;я може бути передане окремо під час звернення.
        </p>
        <p>
          Форма оцінки також може містити марку, модель, рік випуску, опис стану або проблеми та бажану ціну автомобіля. Ця інформація використовується виключно для підготовки попередньої оцінки транспортного засобу.
        </p>
